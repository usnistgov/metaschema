...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc"
  ...
  <p:serialization port="_J1.testdata-xpath-json-result" indent="true"/>
  <p:output        port="_J1.testdata-xpath-json-result" primary="false">
    <p:pipe        port="result" step="convert-supermodel-to-xpath-json"/>
  </p:output>
