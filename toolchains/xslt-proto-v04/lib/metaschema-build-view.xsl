...
<!-- Builds a single tree view unifying XML and JSON views of a metaschema,
     showing all wrappers and settings for both.
...
<!--    -->
    ...
    <xsl:variable name="root-definition" select="/*/define-assembly[exists(root-name)]"/>
