...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="METASCHEMA/define-assembly[not(@name=$assembly-references)]">
    ...
    <xsl:template match="METASCHEMA/define-field[not(@name=$field-references)]">
        <xsl:call-template name="warning">
    ...
    <xsl:template match="METASCHEMA/define-flag[not(@name=$flag-references)]">
        <xsl:call-template name="warning">
